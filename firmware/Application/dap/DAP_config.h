...
__STATIC_INLINE void PORT_SWD_SETUP (void) {
  ...
  GPIO_SetBits(SWD_GPIO, SWCLK_PIN | SWDIO_PIN);
  GPIO_InitTypeDef GPIO_InitStruct;
  GPIO_InitStruct.GPIO_Mode = GPIO_Mode_Out_PP;
  GPIO_InitStruct.GPIO_Pin = SWCLK_PIN | SWDIO_PIN;
...
__STATIC_FORCEINLINE uint32_t PIN_SWCLK_TCK_IN  (void) {
  return GPIO_ReadOutputDataBit(SWD_GPIO, SWCLK_PIN);;
}
...
__STATIC_FORCEINLINE void     PIN_SWCLK_TCK_SET (void) {
  GPIO_SetBits(SWD_GPIO, SWCLK_PIN);
}
...
__STATIC_FORCEINLINE void     PIN_SWCLK_TCK_CLR (void) {
  GPIO_ResetBits(SWD_GPIO, SWCLK_PIN);
}
...
__STATIC_FORCEINLINE uint32_t PIN_SWDIO_TMS_IN  (void) {
  return GPIO_ReadInputDataBit(SWD_GPIO, SWDIO_PIN);
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_TMS_SET (void) {
  GPIO_SetBits(SWD_GPIO, SWDIO_PIN);
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_TMS_CLR (void) {
  GPIO_ResetBits(SWD_GPIO, SWDIO_PIN);
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT_ENABLE  (void) {
  ...
  SWD_GPIO->CFGLR = (SWD_GPIO->CFGLR & ~(0xF << (4*7))) | (0x01 << (4*7));
}
...
__STATIC_FORCEINLINE void     PIN_SWDIO_OUT_DISABLE (void) {
  ...
  // GPIO_InitStruct.GPIO_Speed = GPIO_Speed_50MHz;
  // GPIO_Init(GPIOE, &GPIO_InitStruct);
  SWD_GPIO->CFGLR = (SWD_GPIO->CFGLR & ~(0xF << (4*7))) | (0x04 << (4*7));
}
